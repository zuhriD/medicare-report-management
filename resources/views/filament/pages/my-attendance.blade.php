        ...
        <div
            ...
            <div
                ...
                <div class="p-5 sm:p-6 space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">Siap dibagikan ke WhatsApp beserta foto selfie</p>
                            </div>
                        </div>
                        <button
                            type="button"
                    ...
                    {{-- Actions Section: 1 Single Option Only (Bagikan Laporan Foto + Teks) --}}
                    <div class="space-y-2.5 pt-1">
                        {{-- Single Primary Button: Bagikan Laporan (Foto + Teks) --}}
                        <button
                            type="button"
                            ...
                            <x-heroicon-m-share class="w-5 h-5 shrink-0 group-hover:scale-110 transition-transform text-white" />
                            <span>Bagikan Laporan (Foto + Teks)</span>
                        </button>
                    ...
                    <div class="px-3 py-2 rounded-xl bg-gray-50 dark:bg-gray-950/40 border border-gray-200/80 dark:border-gray-800 text-[10.5px] text-gray-600 dark:text-gray-400 flex items-center gap-2">
                        ...
                        <p class="leading-tight">
                            Klik <strong>Bagikan Laporan</strong> untuk membagikan laporan absensi beserta lampiran foto selfie.
                        </p>
                    </div>
