                ...
                <div>
                    ...
                    <div class="space-y-2.5 p-3.5 bg-gray-50 dark:bg-gray-900/60 rounded-xl border border-gray-100 dark:border-gray-700/50 text-xs">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-black text-gray-900 dark:text-white">
                                {{ $this->todayAttendance?->check_out_at ? $this->todayAttendance->check_out_at->setTimezone($this->office?->timezone ?? 'Asia/Kuala_Lumpur')->format('H:i:s') : ($this->todayAttendance ? 'Sedang Berjalan' : '—') }}
                            </span>
                        </div>
                        <div class="flex justify-between items-center pt-2 border-t border-gray-200/60 dark:border-gray-700/50">
                            <span class="text-gray-500 dark:text-gray-400 font-medium">Durasi Kerja:</span>
                ...
                <div class="pt-2">
                    ...
                    @elseif (!$this->todayAttendance->isCheckedOut())
                        <button 
                            ...
                            <span wire:loading.remove wire:target="doRegularCheckOut">Check-Out Reguler</span>
