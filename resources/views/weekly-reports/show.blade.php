...
<body class="bg-gray-100 p-8 font-sans print:bg-white print:p-0">
    <div class="max-w-5xl mx-auto bg-white p-10 rounded-lg shadow-lg print:shadow-none print:w-full print:max-w-full print:p-0 print:m-0">
        ...
        <div class="flex justify-end mb-4 print:hidden">
            <button onclick="window.print()" class="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-4 rounded shadow flex items-center transition-colors">
        ...
        <div class="mb-12">
            ...
            <div class="mb-8">
                <h3 class="text-xl font-bold text-indigo-700 mb-4 flex items-center gap-3">
                    ...
                    @endphp
                    @if($modulePhase)
                    <span class="bg-blue-100 text-blue-800 text-sm font-medium px-2.5 py-0.5 rounded border border-blue-200">{{ ucfirst($modulePhase) }}</span>
                    @endif
                </h3>
                ...
                <div class="bg-gray-50 rounded-lg p-6 mb-6 shadow-sm border border-gray-200">
        ...
        <div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                    ...
                    <div class="space-y-3">
                        @foreach($reports as $report)
                        <div class="flex items-start text-gray-700 pl-2">
                            <div class="w-2 h-2 rounded-full bg-indigo-500 mt-2 mr-3 flex-shrink-0"></div>
                            <div class="prose prose-sm max-w-none [&>*:last-child]:mb-0 w-full">{!! $report->description !!}</div>
                        </div>
                        @endforeach
